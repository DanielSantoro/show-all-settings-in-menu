...
Tags: Options, Settings, All Options, WordPress Settings
...
This plugin adds an "All Settings" option in your Settings administration panel.

== Description ==

##Description##

This plugin adds an "All Settings" option in your **Settings** administration panel, as shown [in the screenshots tab](http://wordpress.org/plugins/show-all-settings-in-menu/screenshots/).
